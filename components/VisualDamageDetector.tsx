          ...
          <div ref={resultRef} className="mt-8 space-y-6">
            ...
            <div className={`p-6 rounded-2xl border-2 shadow-lg ${
              result.overallAssessment === 'None' 
                ...
                ? 'bg-gradient-to-br from-blue-50 to-orange-50 border-blue-300'
              ...
              <div className="flex items-center justify-between">
                <div>
                  <h2 className={`text-lg sm:text-2xl font-black ${
                    result.overallAssessment === 'None' ? 'text-green-700' : result.overallAssessment === 'Severe' ? 'text-blue-700' : 'text-orange-700'
                  }`}>
