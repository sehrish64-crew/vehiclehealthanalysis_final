            ...
            <div key={tab.id} className="relative min-w-max">
              <button
                ...
                className={`text-xs sm:text-sm md:text-base font-semibold pb-3 px-3 transition ${activeTab === tab.id
                  ? 'text-[#0f4c81]'
                  : 'text-muted-foreground hover:text-[#0f4c81]'
                  }`}
              >
                {tab.label}
              </button>
              ...
              <div className="absolute bottom-0 left-0 right-0 h-1 bg-gray-200 rounded-full overflow-hidden">
                {activeTab === tab.id && (
                  <div className="h-full bg-[#0f4c81] w-full"></div>
                )}
              </div>
            </div>
          ))}
          ...
          {activeTab === 'odometer' && (
            <div className="grid md:grid-cols-2 gap-6 md:gap-10 items-start">
              ...
              <div className="space-y-5">
                <div className="w-14 h-14 bg-[#0f4c81]/10 flex items-center justify-center rounded-xl">
                  <TrendingUp className="text-[#0f4c81]" />
                </div>
                ...
                <Link href="/pricing" className="bg-[#0f4c81] hover:bg-[#0f4c81] text-white px-6 py-3 rounded-full inline-flex items-center gap-2">
          ...
          {activeTab === 'damage' && (
            <div className="grid md:grid-cols-2 gap-6 md:gap-10 items-start">
              ...
              <div className="space-y-5">
                ...
                <Link href="/pricing" className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-full inline-flex items-center gap-2">
          ...
          {activeTab === 'technical' && (
            <div className="grid md:grid-cols-2 gap-6 md:gap-10 items-start">
              ...
              <div className="space-y-5">
                ...
                <button className="bg-[#0f4c81] hover:bg-[#0f4c81] text-white px-6 py-3 rounded-full inline-flex items-center gap-2">
