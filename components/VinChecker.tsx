...
export default function VinChecker() {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative py-16 md:py-20 px-4 bg-gradient-to-br from-[#0f4c81]/10 via-white to-[#0f4c81]/5 overflow-hidden"
    >
      <div className="max-w-6xl mx-auto">

        <div
          className={`relative bg-gradient-to-br from-[#0f4c81] via-[#16589b] to-[#0f4c81] rounded-3xl overflow-hidden shadow-2xl transform transition-all duration-1000 ${
            isVisible ? 'opacity-100 scale-100' : 'opacity-0 scale-95'
          }`}
        >

          {/* Background glow */}
          <div className="absolute inset-0 bg-gradient-to-tr from-[#0f4c81]/40 via-transparent to-black/20"></div>

          <div className="absolute top-0 right-0 w-96 h-96 bg-[#0f4c81]/30 rounded-full blur-3xl animate-pulse"></div>
          ...
          <div className="relative px-6 md:px-12 lg:px-16 py-12 md:py-16 grid lg:grid-cols-2 gap-8 items-center">
            ...
            <div className="space-y-6 text-white">
              ...
              <h2 className="text-xl sm:text-2xl md:text-4xl lg:text-5xl font-bold leading-tight">
                Vehicle Health Analysis Vehicle Intelligence
              </h2>
            ...
            <div className="bg-white rounded-2xl shadow-2xl p-5">
              ...
              <Button
                ...
                className="w-full mt-4 bg-[#0f4c81] hover:bg-[#0f4c81] text-white font-bold py-3 text-sm sm:text-base"
              >
                Get Report
              </Button>

              <p className="text-xs text-gray-500 mt-3 text-center">
                Powered by Vehicle Health Analysis Data Engine
              </p>
