...
export default function WhyVehicleHealthAnalysis() {
  ...
  return (
    <section className="py-16 md:py-24 bg-gradient-to-b from-slate-50 via-white to-blue-50 overflow-hidden">
      <div className="container mx-auto px-6">
        ...
        <div className="relative h-80 sm:h-96 md:h-[500px] rounded-3xl overflow-hidden mb-16 shadow-2xl">
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-black/80 via-black/50 to-[#0f4c81]/40"></div>
          ...
          <div className={`absolute inset-0 flex items-center justify-start transition-all duration-1000 ${isVisible ? 'opacity-100' : 'opacity-0'}`}>
            <div className="px-6 md:px-12 max-w-lg space-y-6">
              ...
              <button
                ...
                className="px-6 py-3 bg-gradient-to-r from-[#0f4c81] to-blue-700 text-white font-bold rounded-xl shadow-lg hover:scale-105 transition-all duration-300"
              >
                Check VIN Now
              </button>
        ...
        <div className="mt-20 rounded-3xl overflow-hidden relative">
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-[#0f4c81] via-blue-800 to-black"></div>
