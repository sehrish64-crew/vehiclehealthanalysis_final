              ...
              <div className="flex flex-col gap-3">
                <div className="flex items-center justify-between">
                  <div className="inline-flex items-center bg-white/10 p-1 rounded-full gap-0.5 sm:gap-1">
                    <button 
                      ...
                      className={`flex items-center gap-1 sm:gap-2 px-2 sm:px-3 py-1 rounded-full transition-all text-xs sm:text-sm font-medium ${isHydrated && vehicleIdType === 'vin' ? 'bg-[#0f4c81] text-white shadow' : 'text-black hover:bg-white/10'}`}
                ...
                <div className="mt-2 sm:mt-3 md:mt-4 flex">
                  <Button
                    ...
                    className="bg-[#0f4c81] hover:bg-[#0d3a64] text-white font-bold h-10 sm:h-12 px-4 sm:px-8 w-full shadow-lg hover:shadow-xl transition-all disabled:opacity-50 disabled:cursor-not-allowed text-sm sm:text-base"
              ...
              <div className="space-y-2 bg-white/10 backdrop-blur-sm rounded-lg sm:rounded-xl p-3 sm:p-4 border border-white/20">
                ...
                <div className="grid grid-cols-2 gap-x-3 sm:gap-x-6 gap-y-1.5 sm:gap-y-2 mt-2 sm:mt-3">
                  <div className="flex items-center gap-1.5 sm:gap-2 text-xs sm:text-sm text-white/95">
                    <CheckCircle2 className="w-3 sm:w-4 h-3 sm:h-4 text-[#0f4c81] flex-shrink-0" />
          ...
          {/* <div className="hidden md:flex justify-center items-center relative">
            <div className="relative w-full max-w-md">
              ...
              <div className="relative animate-float">
                <div className="absolute -inset-4 bg-gradient-to-r from-[#0f4c81] via-blue-500 to-cyan-500 rounded-3xl opacity-30 blur-2xl animate-spin-slow"></div>
              ...
              <div className="absolute -top-8 -right-8 w-24 h-24 bg-[#0f4c81] rounded-full flex items-center justify-center shadow-xl animate-bounce-slow z-10">
        ...
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-lg max-w-3xl w-full max-h-[90vh] overflow-y-auto shadow-2xl">
            ...
            <div className="bg-slate-50 px-8 py-4 border-t border-slate-200 text-center text-xs text-slate-500">
              <p>Vehicle Health Analysis Vehicle Report • Report Generated from NHTSA Database</p>
            </div>
          </div>
        </div>
      )}
