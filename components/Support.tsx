...
const supportStats = [
  {
    ...
    color: 'from-[#0f4c81] to-[#0d3a64]',   // 🔴 changed
    iconColor: 'text-[#0f4c81]',           // 🔴 changed
  ...
  },
  {
    ...
    color: 'from-[#0f4c81] to-[#3a0000]',  // 🔴 changed
  ...
  },
  {
    ...
    color: 'from-[#0f4c81] to-[#8b0000]',  // 🔴 changed
    iconColor: 'text-[#0f4c81]',
    bgColor: 'bg-[#f3e6e6]',
  },
]
...
export default function Support() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-20 left-20 w-64 h-64 bg-[#0f4c81]/20 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-blob"></div>
      <div className="absolute bottom-20 right-20 w-64 h-64 bg-[#0d3a64]/20 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-blob animation-delay-2000"></div>
