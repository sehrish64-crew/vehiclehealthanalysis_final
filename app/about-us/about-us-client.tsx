...
export default function AboutUsClient() {
  ...
  return (
    <div className="bg-white">
      ...
      {/* HERO */}
      <div className="relative overflow-hidden bg-gradient-to-br from-[#0f4c81]/10 via-white to-gray-50">
      ...
      <div className="bg-gradient-to-b from-white to-gray-50 py-10 sm:py-12 md:py-16">
        <div className="container mx-auto px-4 grid lg:grid-cols-2 gap-10 items-center">
          ...
          <div className="space-y-4 sm:space-y-5">
            ...
            <div className="flex gap-4 pt-2">
              <div className="flex items-center gap-2 text-gray-700">
                <Award className="text-[#0f4c81]" /> Trusted Reports
              </div>
              <div className="flex items-center gap-2 text-gray-700">
                <Heart className="text-[#0f4c81]" /> User Focused
              </div>
            </div>
          ...
          <div className="relative">
            <div className="absolute -inset-4 bg-[#0f4c81]/10 rounded-3xl blur-2xl"></div>
