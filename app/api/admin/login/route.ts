...
export async function POST(request: Request) {
  try {
    ...
    const envAdminEmail = process.env.ADMIN_EMAIL || 'admin@vehiclehealthanalysis.com';
    ...
    if ((username === envAdminEmail || username === 'admin@vehiclehealthanalysis.com') && password === envAdminPass) {
